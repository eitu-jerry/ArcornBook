...
import com.eitu.arcornbook.databinding.FragmentCard3Binding
import java.text.SimpleDateFormat
import java.util.*

class Card3Fragment : Fragment() {

    lateinit var binding:FragmentCard3Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCard3Binding.inflate(inflater, container, false)
    ...
    fun setByDate(fDate:Long, tDate:Long){
        ...
        list.clear()
        list.addAll(helper.selectDate("Card3", fDate, tDate))
    ...
    private fun setRecycler(){
        ...
        if(list.size == 0){
            ...
            binding.nothing.visibility = View.INVISIBLE
            for(index in list){
                groupItemList.add(GroupItem(index, helper.selectCard3ByDay(index)))
            }
        }
        adapter.list = groupItemList
    }
